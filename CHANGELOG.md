...
## [v5.1.7.02](https://github.com/mutms/moodle-tool_mutenancy/compare/v5.1.7.01...v5.1.7.02) - 2026-09-18
...
- Security only fixes for Moodle 4.5 – 5.2, version pinned to 2026091851.xx
